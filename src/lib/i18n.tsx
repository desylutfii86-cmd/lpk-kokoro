...
const translations = {
  ...
  jp: {
    ...
    profile: {
      title: "こころ・ブルブス送出機関",
      historyTitle: "沿革",
      historyText: "LPK SO こころ・ブルブスは、2018年に日本語教育および日本への熟練労働者派遣に特化した職業訓練機関として設立されました。設立当初、LPK SO こころ・ブルブスは技能実習プログラムのためにIM Japanと正式な協力関係を結び、第一期生の募集および研修を開始しました。それ以来、IM Japanのプログラムを通じて200名を超える技能実習生を日本へ送り出すという大きな成果を達成してまいりました。\n\n2021年には、IM Japanのルートに加えて民間ルートによる派遣も開始し、技能実習生の機会を一層拡大するとともに、日本国内の各正式パートナーとの協力関係を強化し、人材派遣の質を確保しています。\n\nそして、2023年8月、LPK SO こころ・ブルブスは正式に登録送出機関 (Sending Organization / SO) として認定されました。この認定は、国際基準に準拠した日本向け人材育成および派遣サービスを提供するという当機関の取り組みを示す重要な節目となりました。",
      visiTitle: "ビジョン",
      visiItems: [
      ...
      ownerTitle: "オーナー",
      directorName: "サイム — こころ・ブルブス 代表取締役（社長）",
      directorBio: "サイム代表は、千葉県で技能実習生として勤務した経験を持ち、夫人のスリ・ムリヤニも茨城県で技能実習を行いました。帰国後、日本で受けた恩に報いるため、日本語学校と独立した送出機関を設立。これまでに約300名の研修生を送り出しています。",
      wifeName: "スリ・ムリヤニ — こころ・ブルブス ゼネラルマネージャー",
      wifeBio: "こころ・ブルブス送出機関のビジネスマネージャーとして、日本への技能実習の質の向上に高い熱意を持って取り組んでいます。専門的な責任を果たすとともに、機関の設立と発展においてオーナーを支える重要な役割を担っています。",
